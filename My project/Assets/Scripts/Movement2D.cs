...
public class Movement2D : MonoBehaviour
{
    ...
    ///<summary>
    ///this mothod is used to make the player dodge or dash
    /// </summary>

    public void Dodger(float boost)
    {
        //this debug lets us know that the logic made is to the dodge itself
        Debug.Log("Dashed");
        moveSpeed += boost;
        //adds the boosts float to moveSpeed either speeding up or slowing down quickly
    }
    #endregion
}